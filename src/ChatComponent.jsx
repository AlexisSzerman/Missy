...
const ChatComponent = () => {
  ...
  const sendMessage = async () => {
    if (input.trim()) {
      ...
      try {
        const response = await axios.post('https://missy-backend.onrender.com/chat', { userInput: input });
...
import { useState } from 'react';
import { Box, IconButton, VStack, HStack, Input, Button, Spinner } from '@chakra-ui/react';
import { ChatIcon, ArrowRightIcon } from '@chakra-ui/icons';
import axios from 'axios';
import ReactMarkdown from 'react-markdown';
